...
//                        System.err.println(drone.getName() + " 비행 준비 완료..");
        ...
        if(flyingMessage == FlyingMessage.STATUS_NEED_STOP_FLYING){
            ...
            if(droneRunner != null){
                ...
                System.out.println("===================================================================");
                System.out.println("++++ 송신 메시지:  비행 중지 필요 상황이 발생하여 " + drone.getName() +
                        "에게 비행 중지를 위한 비행 대기 명령(DO_FLYING_WAIT_FOR_STOP_FLYING) 메시지를 송신하였습니다..");
                System.out.println("===================================================================");
            }
        }
        ...
        /**
         * 정적인 리더로부터 비행 중지 필요(STATUS_NEED_STOP_STATIC_LEADER_FLYING) 메시지를 전송 받았을 때,
         *
         * - 모든 Drone의 비행을 중지한다.
         */
        if(flyingMessage == FlyingMessage.STATUS_NEED_STOP_STATIC_LEADER_FLYING){
            this.doStopAllDrone(flyingMessage);
        }
    ...
    private void doStopDroneFlight(FlyingMessage flyingMessageForMatch, FlyingMessage flyingMessageForOrder){
        ...
        if(droneRunner != null){
            ...
            System.out.println("===================================================================");
            System.out.println("## 기존 Follower의 비행정보를 저장하고, 비행을 중단시킵니다.");
            System.out.println("===================================================================");
    ...
    private void doStopAllDrone(FlyingMessage flyingMessage){
        ...
        if(matchedDroneRunner != null){
            Drone drone = matchedDroneRunner.getDroneFromClient();

            System.out.println("===================================================================");
            System.out.println("++++ 수신 메시지:  " + drone.getName() + "으로부터 정적인 리더 비행 중지 필요(STATUS_NEED_STOP_STATIC_LEADER_FLYING) 메시지를 수신하였습니다..");
            System.out.println("===================================================================");
            ...
            System.out.println("===================================================================");
            System.out.println("++++ 송신 메시지:  모든 Drone의 비행 중지 필요 상황이 발생하여 " +
                    "비행 중지 명령(DO_FLYING_STOP) 메시지를 송신하였습니다..");
            System.out.println("===================================================================");
        }


        DroneController.droneRunnerRepository.removeAllDroneRunner();
